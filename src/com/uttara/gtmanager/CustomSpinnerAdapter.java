...
public class CustomSpinnerAdapter extends ArrayAdapter {
	...
	private List<MemberBeanParcable> sList = new ArrayList<MemberBeanParcable>();
	public CustomSpinnerAdapter(Activity activity, int textViewResourceId, List<MemberBeanParcable> objects) {
